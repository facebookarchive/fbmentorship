...
Open source projects generally guide you on what they're looking for in terms of how to contribute. These are typically outlined in a top-level file named `CONTRIBUTING.md`. Check out the [Create React App example](https://github.com/facebook/create-react-app/blob/next/CONTRIBUTING.md).
